...
class IdolGroupLookupService: ObservableObject {
    ...
    private var idolsById: [String: IdolMaster] = [:]
    private var groupsById: [String: GroupMaster] = [:]
    ...
    /// Find idol by ID
    func findIdol(byId id: String) -> IdolMaster? {
        return idolsById[id]
    }

    /// Find group by ID
    func findGroup(byId id: String) -> GroupMaster? {
