            ...
            ZStack {
                ...
                ScrollView {
                    VStack(spacing: Constants.Spacing.medium) {
                        // Single Points Balance Card（単一ポイント制）
                        SinglePointsBalanceCard(points: viewModel.points)
                            ...
                            if viewModel.isLoadingHistory && viewModel.transactions.isEmpty {
                                ...
                                LazyVStack(spacing: 0) {
                                    ForEach(viewModel.transactions) { transaction in
                                        TransactionRow(transaction: transaction, showPointType: false)
...
// MARK: - Points Balance Card（単一ポイント制 - ダークテーマ用）
