        ...
        VStack(alignment: .leading, spacing: Constants.Spacing.small) {
            ...
            VStack(spacing: 0) {
                ...
                NotificationToggleRow(
                    icon: "person.2.fill",
                    title: "同じ推しファン",
                    subtitle: "同じ推しの新規ファンが増えたとき",
                    color: .yellow,
                    isOn: $viewModel.sameBiasFansEnabled
                )
            }
            .background(Constants.Colors.cardDark)
            .cornerRadius(16)
...
class NotificationsViewModel: ObservableObject {
    ...
    @Published var sameBiasFansEnabled = true {
        didSet { if !isLoading { saveSettings(key: "sameBiasFans", value: sameBiasFansEnabled) } }
    }
    ...
    func loadSettings() async {
        ...
        do {
            ...
            sameBiasFansEnabled = settings.sameBiasFans
        } catch {
