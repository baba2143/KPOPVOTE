...
struct MusicVideoContent: Codable {
    ...
    init(youtubeVideoId: String, youtubeUrl: String, title: String, thumbnailUrl: String, channelName: String? = nil) {
...
struct PostContent: Codable {
    ...
    var musicVideo: MusicVideoContent?

    enum CodingKeys: String, CodingKey {
        case text, images, voteIds, voteSnapshots, myVotes, goodsTrade, musicVideo
    ...
    init(text: String? = nil, images: [String]? = nil, voteIds: [String]? = nil, voteSnapshots: [InAppVote]? = nil, myVotes: [MyVoteItem]? = nil, goodsTrade: GoodsTradeContent? = nil, collectionId: String? = nil, collectionTitle: String? = nil, collectionDescription: String? = nil, collectionCoverImage: String? = nil, collectionTaskCount: Int? = nil, musicVideo: MusicVideoContent? = nil) {
        self.text = text
        self.images = images
    ...
    init(from decoder: Decoder) throws {
        ...
        musicVideo = try container.decodeIfPresent(MusicVideoContent.self, forKey: .musicVideo)
    ...
    func encode(to encoder: Encoder) throws {
        ...
        try container.encodeIfPresent(musicVideo, forKey: .musicVideo)
    }
}
